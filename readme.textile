...
The wrapper __limits window sizes__ to 512 or 1024 samples and __applies a Hamming window__ automatically. If other window sizes or types are needed a change to the wrapper followed by recompilation is needed. Also, the time series samples are expected to be 32bit floats.
